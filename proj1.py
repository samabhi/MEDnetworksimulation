...
amount_customer = [1, 10]                 # Min/max levels of fuel tanks (in liters)
medication_buying_speed = 1               # liters / second
time_to_deliver = [100, 400]              # Seconds it takes the tank truck to arrive
customer_arrival_times = [10, 300]        # Create a car every [min, max] seconds
